...
void init_cam(void) {
  e_poxxxx_init_cam();
  e_poxxxx_config_cam((ARRAY_WIDTH - CAM_WIDTH * CAM_ZOOM) / 2, (ARRAY_HEIGHT - CAM_HEIGHT * CAM_ZOOM) / 2,
                      CAM_WIDTH * CAM_ZOOM, CAM_HEIGHT * CAM_ZOOM, CAM_ZOOM, CAM_ZOOM, RGB_565_MODE);
...
DeviceTag wb_robot_get_device(const char *name) {
  if (name == NULL)
    return DT_NULL;
  if (name[0] == 'p' && name[1] == 's' && name[3] == '\0') {
    if (name[2] >= '0' && name[2] <= '7')
      return name[2] - '0' + DT_PS0;
  } else if (name[0] == 'l' && name[1] == 's' && name[3] == '\0') {
    if (name[2] >= '0' && name[2] <= '7')
      return name[2] - '0' + DT_LS0;
  } else if (name[0] == 'g' && name[1] == 's' && name[3] == '\0') {
    if (name[2] >= '0' && name[2] <= '2')
      return name[2] - '0' + DT_FS0;
  } else if (name[0] == 'l' && name[1] == 'e' && name[2] == 'd' && name[4] == '\0') {
    if (name[3] >= '0' && name[3] <= '9')
      return name[3] - '0' + DT_LED0;
  } else if (name[0] == 'c' && name[1] == 'a' && name[2] == 'm' && name[3] == 'e' && name[4] == 'r' && name[5] == 'a' &&
             name[6] == '\0') {
    return DT_CAM;
  } else if (name[0] == 'a' && name[1] == 'c' && name[2] == 'c' && name[3] == 'e' && name[4] == 'l' && name[5] == 'e' &&
             name[6] == 'r' && name[7] == 'o' && name[8] == 'm' && name[9] == 'e' && name[10] == 't' && name[11] == 'e' &&
             name[12] == 'r' && name[13] == '\0') {
    return DT_ACC;
  } else if (name[0] == 'l' && name[1] == 'e' && name[2] == 'f' && name[3] == 't' && name[4] == ' ' && name[5] == 'w' &&
             name[6] == 'h' && name[7] == 'e' && name[8] == 'e' && name[9] == 'l' && name[10] == ' ') {
    if (name[11] == 'm' && name[12] == 'o' && name[13] == 't' && name[14] == 'o' && name[15] == 'r' && name[16] == '\0') {
      return DT_MOTOR_L;
    } else if (name[11] == 's' && name[12] == 'e' && name[13] == 'n' && name[14] == 's' && name[15] == 'o' && name[16] == 'r' &&
               name[17] == '\0') {
      return DT_POSITION_SENSOR_L;
    }
  } else if (name[0] == 'r' && name[1] == 'i' && name[2] == 'g' && name[3] == 'h' && name[4] == 't' && name[5] == ' ' &&
             name[6] == 'w' && name[7] == 'h' && name[8] == 'e' && name[9] == 'e' && name[10] == 'l' && name[11] == ' ') {
    if (name[12] == 'm' && name[13] == 'o' && name[14] == 't' && name[15] == 'o' && name[16] == 'r' && name[17] == '\0') {
      return DT_MOTOR_R;
    } else if (name[12] == 's' && name[13] == 'e' && name[14] == 'n' && name[15] == 's' && name[16] == 'o' && name[17] == 'r' &&
               name[18] == '\0') {
...
void wb_led_set(DeviceTag dt, int value) {
  if (value == 0 || value == 1) {
    ...
    if (dt >= DT_LED0 && dt <= DT_LED7)
      e_set_led(dt - DT_LED0, value);
  }
}
...
double wb_distance_sensor_get_value(DeviceTag dt) {
  if (dt >= DT_PS0 && dt <= DT_PS7 && ps_enable[dt - DT_PS0]) {
    ...
    if (last_duration == 0 || (step_counter % (fs_sampling_period[dt - DT_FS0] / last_duration)) == 0) {
      e_i2cp_enable();
      fs_last_value[dt - DT_FS0] = (double)((unsigned int)e_i2cp_read(0xC0, 2 * (dt - DT_FS0) + 1) +
