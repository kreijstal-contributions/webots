...
#define FRAME_WIDTH 0x0353
  0x04, (unsigned char)(FRAME_WIDTH >> 8), 0x05, (unsigned char)FRAME_WIDTH,
#define FRAME_HEIGTH 0x01e8
  0x06, (unsigned char)(FRAME_WIDTH >> 8), 0x07, (unsigned char)FRAME_WIDTH,
...
#define COLGAIN_BASE 29
  0x15, 0x10, 0x16, 0x40, 0x17, 0x40, 0x18, 0x40, 0x19, 0x40,
#define INTEGR_BASE 39
  0x1a, 0x03, 0x1b, 0xe6, 0x1c, 0x00,
#endif
...
#define FLICKP_BASE 59
  0x49, 0x96, 0x4a, 0x00, 0x4b, 0x7d, 0x4c, 0x00,
#endif
...
#define GAMMA_BASE 83
  0x76, 0x00, 0x77, 0x1a, 0x78, 0x2a, 0x79, 0x37, 0x7a, 0x42, 0x7b, 0x56, 0x7c, 0x68, 0x7d, 0x87, 0x7e, 0xa3, 0x7f, 0xbc, 0x80,
  0xd4, 0x81, 0xea,
#define COLOR_COEF_BASE 107
  0x8e, 0x38, 0x8f, 0xa5, 0x90, 0x0d, 0x91, 0x93, 0x92, 0x2d, 0x93, 0x06, 0x94, 0x83, 0x95, 0xaa, 0x96, 0x4d,
#define CBCRGAIN_BASE 125
  0x97, 0x25, 0x98, 0x25,
#define BRICTR_BASE 129
  0x9b, 0x00, 0x9c, 0x96,
#define SEPIATONE_BASE 133
  0x9f, 0x80, 0xa0, 0x80, 0xa1, 0xb6, 0xa2, 0x9d, 0xa3, 0xab, 0xa4, 0x80,
#endif
...
#define EXPOSURE_BASE 163
  0xb0, 0x07, 0xb1, 0xcc, 0xb2, 0x00,
#define REFREPO_BASE 169
  0xb3, 0x70, 0xb9, 0x03, 0xba, 0xe6,
#define MINMAXEXP_BASE 175
  0xbb, 0x07, 0xbc, 0xcc, 0xbd, 0x00, 0xbe, 0x0c,
#define MINMAXAWB_BASE 183
  0xc1, 0x10, 0xc2, 0xe0, 0xc3, 0x10, 0xc4, 0xe0, 0xc5, 0x80, 0xc6, 0x80,
#define WEIGHWIN_BASE 195
  0xc7, 0x01, 0xc8, 0xa5, 0xc9, 0x02, 0xca, 0x7a, 0xcb, 0x00, 0xcc, 0xa7, 0xcd, 0x01, 0xce, 0x47,
...
int e_po3030k_set_sampling_mode(int mode) {
  if (mode == MODE_VGA || mode == MODE_QVGA || mode == MODE_QQVGA) {
...
int e_po3030k_set_speed(int mode) {
  if (mode == SPEED_2 || mode == SPEED_4 || mode == SPEED_8 || mode == SPEED_16 || mode == SPEED_32 || mode == SPEED_64 ||
