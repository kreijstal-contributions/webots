 ...
 * https://stackoverflow.com/questions/23032002/c-c-how-to-get-integer-unix-timestamp-of-build-time-not-string and Alexis Wilke
 * |   https://stackoverflow.com/questions/10538444/do-you-know-of-a-c-macro-to-compute-unix-time-and-date
 *
 * Assembled by Jean Rabault
 *
 * UNIX_TIMESTAMP gives the UNIX timestamp (unsigned long integer of seconds since 1st Jan 1970) of compilation from macros
 * using the compiler defined __TIME__ macro. This should include Gregorian calendar leap days, in particular the 29ths of
 * February, 100 and 400 years modulo leaps.
 *
...
#define _UNIX_TIMESTAMP_YDAY(year, month, day)                                                                            \
  (/* January */ day /* February */ + (month >= 2 ? 31UL : 0UL) /* March */ +                                             \
   (month >= 3 ? _UNIX_TIMESTAMP_FDAY(year) : 0UL) /* April */ + (month >= 4 ? 31UL : 0UL) /* May */ +                    \
   (month >= 5 ? 30UL : 0UL) /* June */ + (month >= 6 ? 31UL : 0UL) /* July */ + (month >= 7 ? 30UL : 0UL) /* August */ + \
   (month >= 8 ? 31UL : 0UL) /* September */ + (month >= 9 ? 31UL : 0UL) /* October */ +                                  \
   (month >= 10 ? 30UL : 0UL) /* November */ + (month >= 11 ? 31UL : 0UL) /* December */ + (month >= 12 ? 30UL : 0UL))
...
#define UNIX_TIMESTAMP \
  (_UNIX_TIMESTAMP(__TIME_YEARS__, __TIME_MONTH__, __TIME_DAYS__, __TIME_HOURS__, __TIME_MINUTES__, __TIME_SECONDS__))
